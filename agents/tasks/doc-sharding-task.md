...
2. Validate prerequisites:
   ...
   - Provided `doc-sharding-tmpl.txt` or access to `agents/templates/doc-sharding-tmpl.txt`
...
3. **Sharding Plan** - Confirm `agents/templates/doc-sharding-tmpl.md` exists or `doc-sharding-tmpl.md` has been provided
